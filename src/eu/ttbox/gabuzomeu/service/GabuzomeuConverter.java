...
public class GabuzomeuConverter {
    ...
    private void intitShadokDigit(Context mContext) {
        if (!isInitShadokDigit) {
            ...
            nbToshadokDigitName.put(digitGa, digitNameGa);
            nbToshadokDigitName.put(digitBu, digitNameBu);
            nbToshadokDigitName.put(digitZo, digitNameZo);
            nbToshadokDigitName.put(digitMeu, digitNameMeu);
